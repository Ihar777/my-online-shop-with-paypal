	...
	<div class="main_wrapper">
		...
		<div class="content_wrapper">
			...
			<div id="shopping_cart"> 
					...
					<b style="color:yellow">Shopping Cart -</b> Total Items: <?php total_items();?> Total Price: 
					<?php if(isset($_SESSION['total_price'])){echo $_SESSION['total_price'];} else { total_price(); } ?>
